                            ...
                            <tr class="odd pointer">
                                ...
                                <td><?php echo substr(strip_tags($product->details),0,80);?></td>
                                 <td class=" last" width="100" nowrap>
                                    <a href="<?php echo base_url()?>admin/favourites/edit/<?php echo $product->id?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                    <a href="<?php echo base_url()?>admin/favourites/delete?id=<?php echo $product->id?>" onClick="return confirm('Are you sure to delete this ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete </a>
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
