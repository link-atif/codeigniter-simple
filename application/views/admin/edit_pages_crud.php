                            ...
                            <form method="post" name="frm" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" name="title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['title']) ? $sliderDetail['title'] : '';?>" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Picture(187*184) <span>*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                        ...
                                        <?php if(isset($sliderDetail['picture']) && $sliderDetail['picture']!=''){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    $picture_name = $this->Common_model->resize($sliderDetail['picture'],181,129);
                                                     echo $picture_name;?>" width="100px" height="100px" /></a>
                                                   <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/Pages_crud/deleteSliderImage?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                               </div>
                                          </div>
                                          <?php }?>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                clickable: true,
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/Pages_crud/uploadAddImage/"
                            });
