                ...
                <div class="x_content content">
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Time Period<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control" name="heading" id="heading" required="required">
                                        <option value="weekly">Weekly</option>
                                        <option value="month">Monthly</option>
                                        <option value="year">Yearly</option>
                                    </select>
                                    <script type="text/javascript">
                                        document.frm.heading.value = '<?php echo $sliderDetail['heading']?>';
                                    </script>
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="price">Price<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text" id="price" name="price" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['price']) ? $sliderDetail['price'] : '';?>" />
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="price">Trial Period<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="number" id="trial_period" name="trial_period" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['trial_period']) ? $sliderDetail['trial_period'] : '';?>" />
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Main Picture((191*155))<span>*</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/plans/deleteimageFirst?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/plans/uploadAddImage/"
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/plans/uploadAddImage1/"
