                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Main Picture(400×318)<span>*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <div class="form-group" id="uploadVideo">
                                ...
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Upload Video
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">&nbsp;</label>
