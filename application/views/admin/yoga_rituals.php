                ...
                <div class="x_content content">
                    ...
                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                        ...
                        <tbody>
                            <?php 
                                $i=1;
                                foreach($yoga_rituals as $product){
                            ...
                            <tr class="odd pointer">
                                ...
                                <td><?php echo substr(strip_tags($product->details),0,80);?></td>
                                 <td class=" last" width="100" nowrap>
                                    <a href="<?php echo base_url()?>admin/yoga_rituals/edit/<?php echo $product->id?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                    <a href="<?php echo base_url()?>admin/yoga_rituals/delete?id=<?php echo $product->id?>" onClick="return confirm('Are you sure to delete this ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete </a>
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
