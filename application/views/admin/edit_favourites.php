                            ...
                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/favourites/deleteimageFirst?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/favourites/deleteimageSecond?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/favourites/uploadAddImage/"
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/favourites/uploadAddImage1/"
