                        ...
                        <div class="x_panel">
                            ...
                            <form method="post" name="frm" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Slider For<span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <select type="text" id="type" name="type" class="form-control col-md-7 col-xs-12">
                                                    <option value="retreat" <?php if ($sliderDetail['type'] =='retreat') {?> selected <?php } ?>>Retreats</option>
                                                    <option value="ondemand"<?php if ($sliderDetail['type'] =='ondemand') {?> selected <?php } ?>>Main Subscription</option>
                                                    <option value="dubai"<?php if ($sliderDetail['type'] =='dubai') {?> selected <?php } ?>>Dubai Studio</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Picture(1920*736) <span>*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <a href="<?php echo base_url();?>uploads/slider/<?php echo $sliderDetail['picture'] ? $sliderDetail['picture'] :''; ?>" class="group1"><img src="<?php echo base_url();?>uploads/slider/<?php
                                    $picture_name = $this->Common_model->resize($sliderDetail['picture'],250,150);
