                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Main Picture(350×249)<span>*</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/retreats/deleteimageFirst?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/retreats/uploadAddImage/"
