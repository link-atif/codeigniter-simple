                ...
                <div class="x_content content">
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" novalidate>
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select name="testimonial_page" id="testimonial_page" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <option value="0">Retreats</option>
                                        <option value="1">Membership</option>
                                        <option value="2">Live Stream Classes</option>
                                    </select>
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Testimonial Message<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea name="testimonial_message" class="form-control col-md-7 col-xs-12"><?php echo isset($productDetail['testimonial_message']) ? $productDetail['testimonial_message'] : '';?></textarea>
                                </div>
                            </div>
