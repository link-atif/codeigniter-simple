                        ...
                        <div id="tabs">
                            ...
                            <ul>
                                ...
                                {   
                                    ...
                                    echo '<li><a href="#tabs-'.$language->language_id.'">'.$language->Name.'</a></li> '; 
                                    ...
                                    <div id="tabs-<?php echo $language->language_id; ?>">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                ...
                                                <input type="text" id="title" name="tittle[<?php echo $language->id ?>][tittle]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail['title']) ? $pageDetail['title'] : '';?>" />
...

                                        {
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <input type="text" id="title" name="link" required="required" class="form-control col-md-7 col-xs-12" />
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                ...
                                                <textarea id="description" name="description[<?php echo $language->id ?>][description]" class="form-control col-md-7 col-xs-12"><?php echo isset($sliderDetail['description']) ? $sliderDetail['description'] : '';?></textarea>
...

                                        {
                                            ...
                                            <div id="ifImage">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="picture_name" id="picture_name" required="">
...
<script>
    ...
    $('.uploadingOption').click(function(){
...

        {
            ...
            $('#picture_name').removeAttr("required");
