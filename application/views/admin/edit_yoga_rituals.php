                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text" id="heading" name="heading" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['heading']) ? $sliderDetail['heading'] : '';?>" />
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/yoga_rituals/deleteimageFirst?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/yoga_rituals/deleteimageSecond?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/yoga_rituals/uploadAddImage/"
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/yoga_rituals/uploadAddImage1/"
