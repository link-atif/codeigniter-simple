                        ...
                        <div class="x_panel">
                            ...
                            <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                         ...
                                         <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Like<span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="number" name="like" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['like']) ? $sliderDetail['like'] : '';?>" />
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Comment<span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="number" name="comment" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['comment']) ? $sliderDetail['comment'] : '';?>" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                clickable: true,
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/Instagram/uploadAddImage/"
                            });
