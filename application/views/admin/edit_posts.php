                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Main Picture(645*434)<span>*</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/slider/<?php
                                                    $picture_name = $this->Common_model->resize($sliderDetail['picture_main'],250,250);
                                                     echo $picture_name;?>" class="group1"><img src="<?php echo base_url();?>uploads/slider/<?php echo isset($sliderDetail['picture_main']) ? $sliderDetail['picture_main'] : '';?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/posts/deleteimageFirst?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>

                                                </div>
                                            </div>
                                            <?php }?>
                                            <input type="hidden" name="old_main_picture" id="old_picture" value="<?php echo $sliderDetail['picture_main']?>">
                                            <input type="hidden" name='id' value="<?php echo $sliderDetail['id'] ?>">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/posts/uploadAddImage/"
                            });
