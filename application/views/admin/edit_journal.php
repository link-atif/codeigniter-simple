                ...
                <div class="x_content content">
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="heading">Date<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="date" id="date" name="date" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['date']) ? $sliderDetail['date'] : '';?>" />
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Main Picture(350×232)<span>*</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    $picture_name = $this->Common_model->resize($sliderDetail['picture_main'],250,150);
                                                     echo $picture_name;?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/journal/deleteimageFirst?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Detail Page Picture(895*595)<span>*</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/slider/<?php echo $sliderDetail['picture_s1']?>" class="group1"><img src="<?php echo base_url();?>uploads/slider/<?php
                                                    $picture_name = $this->Common_model->resize($sliderDetail['picture_s1'],250,150);
                                                     echo $picture_name;?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/journal/deleteimageSecond?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/journal/uploadAddImage/"
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                url: "<?php echo base_url()?>admin/journal/uploadAddImage1/"
