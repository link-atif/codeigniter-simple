                    ...
                    <div class="x_content">
                        <div class="x_panel">
                            ...
                            <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Show On Home Page<span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" name="sort_order" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['sort_order']) ? $sliderDetail['sort_order'] : '';?>" />
                                            </div>
                                        </div>
                                ...
                                <input value="<?php echo isset($sliderDetail['picture']) ? $sliderDetail['picture'] : '';?>" name="image" type="file" id="upload" class="hidden" onChange="">
                            </form>
                        </div>
                    </div>
                </div>
